...
Flexigift stores a list of items that are eligible to be purches with a customer's gift card. The Products service contains information about these items.
...
| -------------   | ------------- | ---        | ---         | ---   |
| product_id      | string        | true       | -           | Unique ID proviced by the manufacturer. |
| name            | string        | true       | -           | -    |
| price           | float         | true       | -           | -      |
